...
public class CreatePanel extends JPanel implements KeyListener {
    ...
    CreatePanel() {
        ...
        for (int i = 0; i < 10; i++) {
            myImage[i] = Toolkit.getDefaultToolkit().getImage("D:\\File\\Project\\s\\JAVA\\pushBox\\src\\main\\java\\cn\\xf\\pic\\" + i + ".gif");
        }
    ...
    void Tuixiangzi(int i) {
        Levelmap = new MapSource(i);
        Levelmaptmp = new MapSource(i);
        map = Levelmap.getmap();
